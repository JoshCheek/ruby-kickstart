...
=== It's hot! 
==== One of my instructors just sent this to our school's ACM mailing list:

<b>% change in job openings from 2010</b>
- Ruby on Rails        +84%
- Python               +53%
- MySQL                +46%
- PHP                  +43%
...
<b>Source: Dice.com via May 9, 2011 ComputerWorld</b>

=== Okay, but what about Ruby not Rails?

<b>$ rvm list known</b>
    
<b>See MacRuby? I predict Apple moves from Objective C to MacRuby.
...
when the iPhone came out? That boost can shift towards Ruby.</b>
   
<b>See JRuby? The JVM is awesome, you have that power in Ruby. There 
are awesome Java libraries. You have that power in Ruby. Native
threading in Ruby. Anywhere the JVM is ( portability ).</b>

<b>Rubyists are happy. We love to program. We love elegance.
...
and pushing boundaries.</b> 

<b>Think about it, you can conceive of your own problems. And you can solve them.
You can create anything you can conceive of, like a brilliant architect.</b>

<b>"Whoever holds the keys to programming ends up building the reality in which the rest of us live."</b>
