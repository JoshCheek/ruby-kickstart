...
==== when a user passes an argument to a ruby program it is stored in the ARGV array.
 unless ARGV.first
  puts "You need to submit a number to check"
  # If you're exiting because something went wrong, pass a number like 1
  # Use exit( 0 ) to exit the program early.
  exit( 1 ) 
 end        
